...
class s2wpml_admin_settings_page {
	 ...
	 * admin_menu
	 *
	 * This function will add Advanced Woocommerce Product Filters submenu item to the WP admin
	 *
	 * @since		1.0.0
	 * @param		N/A
	 * @return		N/A
	...
	function admin_menu() {
		...
		if( ! s2wpml_get_setting( 'show_admin' ) )
			return;

		// vars
		$capability = s2wpml_get_setting( 'capability' );
